...
"}\n"
"\n"
"#firstFit_btn, #nextFit_btn, #bestFit_btn, #worstFit_btn {\n"
"    border-radius: 6px;\n"
"    padding: 4px 6px;\n"
"    background-color: #4e4e4e;\n"
"\n"
...
"")
        ...
        self.frame_7.setMinimumSize(QtCore.QSize(70, 0))
        self.frame_7.setMaximumSize(QtCore.QSize(70, 16777215))
        ...
        self.autoRun_checkbox = QtWidgets.QCheckBox(self.frame_14)
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(True)
        font.setWeight(62)
        ...
        self.horizontalLayout_8.addWidget(self.autoRun_checkbox)
        self.verticalLayout_5.addWidget(self.frame_14)
        self.firstFit_btn = QtWidgets.QPushButton(self.frame_8)
        self.firstFit_btn.setMinimumSize(QtCore.QSize(0, 36))
        self.firstFit_btn.setMaximumSize(QtCore.QSize(16777215, 50))
        font = QtGui.QFont()
        font.setPointSize(11)
        font.setBold(True)
        font.setWeight(62)
        ...
        self.verticalLayout_5.addWidget(self.firstFit_btn)
        self.nextFit_btn = QtWidgets.QPushButton(self.frame_8)
        font = QtGui.QFont()
        font.setPointSize(11)
        font.setBold(True)
        font.setWeight(62)
        self.nextFit_btn.setFont(font)
        self.nextFit_btn.setObjectName("nextFit_btn")
        self.verticalLayout_5.addWidget(self.nextFit_btn)
        self.bestFit_btn = QtWidgets.QPushButton(self.frame_8)
        font = QtGui.QFont()
        font.setPointSize(11)
        font.setBold(True)
        font.setWeight(62)
        ...
        self.verticalLayout_5.addWidget(self.bestFit_btn)
        self.worstFit_btn = QtWidgets.QPushButton(self.frame_8)
        font = QtGui.QFont()
        font.setPointSize(11)
        font.setBold(True)
        font.setWeight(62)
        self.worstFit_btn.setFont(font)
        self.worstFit_btn.setObjectName("worstFit_btn")
        self.verticalLayout_5.addWidget(self.worstFit_btn)
        self.verticalLayout_4.addWidget(self.frame_8, 0, QtCore.Qt.AlignHCenter|QtCore.Qt.AlignTop)
        ...
        self.processOVBar.setGeometry(QtCore.QRect(0, 0, 523, 406))
        ...
        self.frame_3 = QtWidgets.QFrame(self.animationArea)
        ...
        self.fitTitle_lb = QtWidgets.QLabel(self.frame_3)
        font = QtGui.QFont()
        font.setPointSize(14)
        font.setBold(True)
        font.setWeight(62)
        self.fitTitle_lb.setFont(font)
        self.fitTitle_lb.setAlignment(QtCore.Qt.AlignHCenter|QtCore.Qt.AlignTop)
        self.fitTitle_lb.setObjectName("fitTitle_lb")
        self.verticalLayout_16.addWidget(self.fitTitle_lb)
        ...
        self.ramBar_w.setGeometry(QtCore.QRect(0, 0, 168, 350))
        ...
        self.tempBar_w.setGeometry(QtCore.QRect(0, 0, 190, 352))
        ...
        self.processBar_w.setGeometry(QtCore.QRect(0, 0, 190, 352))
    ...
    def retranslateUi(self, DemoFrame):
        ...
        self.label.setText(_translate("DemoFrame", "Tốc độ:"))
        ...
        self.autoRun_checkbox.setText(_translate("DemoFrame", "Auto run"))
        self.firstFit_btn.setText(_translate("DemoFrame", "First Fit"))
        self.nextFit_btn.setText(_translate("DemoFrame", "Next Fit"))
        self.bestFit_btn.setText(_translate("DemoFrame", "Best Fit"))
        self.worstFit_btn.setText(_translate("DemoFrame", "Worst Fit"))
        self.label_5.setText(_translate("DemoFrame", "Chi tiết"))
        self.fitTitle_lb.setText(_translate("DemoFrame", "First Fit"))
